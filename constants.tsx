...
export const NAV_LINKS = [
  ...
  },
  {
    name: 'Menu',
    path: '/menu',
    icon: <Icon path="M12 6.253v11.494m-9-5.747h18" />,
  },
  {
    name: 'Tables',
    path: '/tables',
    icon: <Icon path="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />,
  },
    {
    name: 'Inventaire',
    path: '/inventory',
    icon: <Icon path="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />,
  },
  {
    name: 'Achats',
    path: '/purchases',
  ...
  },
  {
    name: 'Personnel',
    path: '/staff',
    icon: <Icon path="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm-1-5a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />,
  },
  {
    name: 'Rapports',
    path: '/reports',
